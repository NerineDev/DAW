...
| File | Description |
|---|---|
| `index.html` | Main interface of the incident management panel. |
| `css/styles.css` | Visual styles for the application, including active and resolved incident states. |
| `js/app.js` | Main JavaScript logic: incident creation, JSON handling, WebSocket simulation, XML loading and DOM updates. |
| `data/incidentes-historicos.xml` | External XML file used to load historical incidents. |
| `tests/tests.html` | Page used to run the project tests. |
| `tests/tests.js` | Unit and functional tests. |
...
- JSON
- XML
- WebSocket structure/simulation
- AJAX with `fetch()`
- DOMParser
- JSDoc
- Unit and functional testing with plain JavaScript
